...
|* `DatabaseError.js`   |   {√}                                               *|
|* —————————————————————————————————————————————————————————————————————————— *| 
|* Throws errors when the database encounters connectivity or configuration   *|
|* issues and fails to recover.                                               *|
\* ------------------------->>All rights reserved.<<------------------------- */
...
\* —————————————————————————————————————————————————————————————————————————— */
/**
 * Throws errors when the database encounters connectivity issues. Extends the
